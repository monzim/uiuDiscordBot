...
var (
	...
	commands = []*discordgo.ApplicationCommand{
		...
		{
			Name:        "author",
			Description: "Command for demonstration of interaction author",
		},
		{
	...
	commandHandlers = map[string]func(s *discordgo.Session, i *discordgo.InteractionCreate){
		"ping": func(s *discordgo.Session, i *discordgo.InteractionCreate) {
			s.InteractionRespond(i.Interaction, &discordgo.InteractionResponse{
				...
				Data: &discordgo.InteractionResponseData{
					Content: fmt.Sprintf("Pong! %v", s.HeartbeatLatency().Round(time.Millisecond)),
				},
			})
		},
		...
		"author": func(s *discordgo.Session, i *discordgo.InteractionCreate) {
			s.InteractionRespond(i.Interaction, &discordgo.InteractionResponse{
				Type: discordgo.InteractionResponseChannelMessageWithSource,
				Data: &discordgo.InteractionResponseData{
					Content: "You are: " + i.Member.User.Username,
				},
			})
		},
